...
public class Tabuleiro implements TabuleiroLIG4{
    ...
    public void isValidCol(int escolha) throws ForaDoIndice, ColunaInvalida {
        if (escolha < 0 || escolha > 6) {
            throw new ForaDoIndice(" ! Sua escolha deve estar entre 1 e 7 !\n");
        }
